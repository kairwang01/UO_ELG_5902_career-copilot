...
export const AdminAccessDenied: React.FC = () => (
  ...
  >
    ...
    <pre className="mt-4 rounded-md bg-gray-100 border border-gray-200 px-3 py-2.5 text-[11px] text-gray-700 font-mono overflow-x-auto">
      cd functions && node scripts/grantAdmin.js your@email.com
    </pre>
    <button
      type="button"
      onClick={() => data.auth.signOut()}
      className="mt-6 w-full rounded-md border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
    >
      Sign out
    </button>
  </AdminAuthLayout>
