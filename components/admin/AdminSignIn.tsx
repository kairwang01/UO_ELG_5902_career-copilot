      ...
      {view === 'sign_in' ? (
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-2.5 top-1/2 -translate-y-1/2 text-xs font-medium text-gray-500 hover:text-gray-700"
        ...
        <form onSubmit={handleReset} className="space-y-5" noValidate>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-md bg-blue-700 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 disabled:opacity-60"
          >
