        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[60] p-4 animate-fade-in" onClick={handleOverlayClick}>
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl flex flex-col max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
                <div className="flex-shrink-0 flex items-center justify-between p-4 border-b">
                    <h3 className="text-xl font-bold text-gray-800">Candidate Profile #{candidate.index + 1}</h3>
                ...
                <div className="flex-grow overflow-y-auto p-6 space-y-6">
                    <div className="text-center p-4 bg-gray-50 rounded-lg border">
                        ...
                        <p className="text-gray-700 mt-3">{candidate.summary}</p>
                    </div>
                     {candidate.wallet_address && (
                        <div>
                            <h4 className="font-bold text-lg text-gray-800 mb-2">Web3 Identity</h4>
                    ...
                    <div>
                        <h4 className="font-bold text-lg text-gray-800 mb-2">Candidate's Full Resume</h4>
                        <div className="h-[40vh]">
                            <ResumePreview resumeText={candidate.resume_text || 'No resume text available.'} market="" t={t} />
                        </div>
                    </div>
                </div>
                <div className="flex-shrink-0 flex justify-between items-center p-4 border-t bg-gray-50 rounded-b-xl">
                    <p className="text-xs text-gray-500">Candidate contact information is kept private.</p>
                    <button 
