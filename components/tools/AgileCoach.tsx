...
const AgileCoach: React.FC<AgileCoachProps> = ({ onClose, t }) => {
  ...
  const renderSetup = () => (
    <div data-qa="agile-coach-tool" data-qa-tool-state="setup" className="space-y-4">
      ...
      <button onClick={handleStartTest} data-qa="agile-coach-generate" disabled={loading} className="w-full bg-blue-700 hover:bg-blue-800 disabled:bg-blue-400 text-white font-bold py-2.5 px-4 rounded-lg">
