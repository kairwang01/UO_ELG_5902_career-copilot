  ...
  return (
    <footer className="border-t border-[var(--site-border)] bg-[var(--site-surface-muted)]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="mt-6 pt-6 border-t border-[var(--site-border)] text-center text-xs text-[var(--site-text-muted)] space-y-2">
          ...
          <p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-[var(--site-action)] hover:underline"
            >
              caiot.co
            </a>
